        ...
        <div class="row">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="well" style="height:300px; width:100%;">
                            ...
                            <img src="../menu/photo_menu/<?php echo $men['photo_menu']?>" height="250" width="350"/>
                            </div>
                            <div style="float:left; margin-left:10px;">
                            <div>
                                <label>Type</label>&nbsp; &nbsp;<?php echo $men['type']?>
                            </div>
                            <div>
                                <label>Menu</label>&nbsp; &nbsp;<?php echo $men['designation']?>
                            </div>
                            <h4 style="color:#black;"><?php echo "Prix: Php. ".$men['prix'].".00"?></h4>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-6">
                <div class="card margetop60">
                    ...
                    <div class="card-body">
                        <form method="post" action="insertCommandeClient.php" class="form" enctype="multipart/form-data"> 
                            <div class="alert alert-info">
                                <label for="id_menu">Menu : <?php echo $idmenu ?> </label>
                                <input type="hidden" name="id_menu" class="form-control" 
                                    value="<?php echo $idmenu ?>"/>
                                <br />
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="numC" placeholder="numéro commande" class="form-control"/>
                            </div>
                            <div class="form-group">
                                <label for="quantite">Quantite : </label>
                                <input type="number" name="quantite" placeholder="qantite" class="form-control"/>
                            </div>
                            <div class="form-group">
                                <label for="dateC">Date : </label>
                                <input type="date" name="dateC" placeholder="date" class="form-control"/>
                            </div>
                            <div class="form-group">
                                <label for="heureC">Heure : </label>
                                <input type="time" name="heureC" placeholder="heure" class="form-control"/>
                            </div>
                            <div class="form-group">
