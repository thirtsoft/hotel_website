        ...
        <div class="container-fluid">
            ...
            <div class="card mb-3">
              <div class="card-body">
                ...
                <?php while($ch=$resultatChambre->fetch()){?>
                  <div class="well" style="height:300px; width:100%;">
                    <div style="float:left;">
                      <img src="../chambres/images_chambre/<?php echo $ch['photo_chambre']?>" height="250" width="350"/>
                    </div>
                    <div style="float:left; margin-left:10px;">
                      <div>
                        <label>Catégorie</label>&nbsp; &nbsp;<?php echo $ch['nom_categorie']?>
                      </div>
                      <div>
