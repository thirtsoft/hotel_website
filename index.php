...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">SUNU-HOTEL@SEN.COM</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>+221 779440310</li>	
					<li class="s-bar">
						<div class="search">
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">SUNU <span>HOTEL</span><p class="logo_w3l_agile_caption">Votre choix de réservation</p></a></h1>
				</div>
				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--iris">
						<ul class="nav navbar-nav menu__list">
							...
							<li class="menu__item"><a href="#gallery" class="menu__link scroll">Photo</a></li>
							<li class="menu__item"><a href="#rooms" class="menu__link scroll">Chambre</a></li>
